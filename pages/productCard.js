...
import { faAngleDown, faAngleUp, faArrowLeft, faArrowRight, faTimes } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <div className="row">
                            <div className="col-md-12 product-swiper swiper_content">
                                <Swiper slidesPerView={5} spaceBetween={0} slidesPerGroup={1} loop={true} loopFillGroupWithBlank={true}
                                    navigation={true} className="mySwiper" pagination={{ "clickable": false }}
                                    breakpoints={{
                                        "300": {
                                            "slidesPerView": 1,
                                            // "spaceBetween": 20
